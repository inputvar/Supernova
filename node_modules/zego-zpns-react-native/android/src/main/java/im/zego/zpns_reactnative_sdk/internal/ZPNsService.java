...
public class ZPNsService extends HeadlessJsTaskService {
    ...
    protected @Nullable HeadlessJsTaskConfig getTaskConfig(Intent intent) {
        ...
        if (extras != null) {
            return new HeadlessJsTaskConfig(
                "ZPNsRNSDKHeadlessJsTaskService",
                Arguments.fromBundle(extras),
                60000, // 任务的超时时间
                true // 可选参数：是否允许任务在前台运行，默认为 false
            );
        }
        return null;
    }
    ...
    static final String TAG = "ZPNs RN Service";
    ...
    static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        JobServiceEngineImpl(ZPNsService service) {
            super(service);
            mService = service;
        }
    ...
    static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        JobWorkEnqueuer(Context context, ComponentName cn, int jobId) {
            ...
            mJobScheduler =
                (JobScheduler) context.getApplicationContext().getSystemService(Context.JOB_SCHEDULER_SERVICE);
        }
    ...
    public void onCreate() {
        super.onCreate();
        ZPNsLogWriter.writeLog("ZPNsService onCreate: " + this, "");
    ...
    public IBinder onBind(@NonNull Intent intent) {
        ...
        if (mJobImpl != null) {
            ...
            ZPNsLogWriter.writeLog("ZPNsService returning engine: " + engine, "");
            return engine;
        } else {
            return null;
        }
    ...
    protected void onHandleWork(@NonNull final Intent intent) {
        final ZPNsService zpNsService = this;
        getHandler()
            .post(
                new Runnable() {
                    @Override
                    public void run() {
                        zpNsService.onStartCommand(intent, 0, 1);
                    }
                }
            );
    }
    ...
    GenericWorkItem dequeueWork() {
        ...
        synchronized (mCompatQueue) {
            if (mCompatQueue.size() > 0) return mCompatQueue.remove(0); else return null;
        }
    }
}
