...
import { ZIMConnectionState, ZIMConnectionEvent, ZIMUserInfo, ZIMMessage, ZIMConversationChangeInfo, ZIMRoomState, ZIMRoomEvent, ZIMRoomAttributesUpdateInfo, ZIMRoomMemberAttributesUpdateInfo, ZIMRoomOperatedInfo, ZIMGroupMemberInfo, ZIMGroupOperatedInfo, ZIMGroupMemberState, ZIMGroupMemberEvent, ZIMGroupFullInfo, ZIMGroupState, ZIMGroupEvent, ZIMGroupAttributesUpdateInfo, ZIMMessageReceiptInfo, ZIMRevokeMessage, ZIMMessageSentStatusChangeInfo, ZIMCallInvitationMode, ZIMCallUserInfo, ZIMMessageReaction } from './ZIMDefines';
