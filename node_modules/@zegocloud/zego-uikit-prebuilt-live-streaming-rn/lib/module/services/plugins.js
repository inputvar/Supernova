import ZegoUIKit, { ZegoUIKitPluginType, ZegoInvitationConnectionState } from '@zegocloud/zego-uikit-rn';
...
const ZegoPrebuiltPlugins = {
  init: (appID, appSign, userID, userName, plugins) => {
    ...
    if (ZegoUIKit.getPlugin(ZegoUIKitPluginType.signaling)) {
      ...
      ZegoUIKit.getSignalingPlugin().onConnectionStateChanged(callbackID, _ref => {
        let {
          state
        } = _ref;
