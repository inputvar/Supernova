...
export default function ZegoLiveStreamingMemberList(props) {
      ...
      setCoHostDialogExtendedData({
        ...
        onOk: () => {
          ...
          setToastExtendedData({
            ...
            text: ZegoTranslationText.inviteCoHostSuccessfullyToast
          });
        },
        onCancel: () => {
          setIsCoHostDialogVisable(false);
  ...
  const renderItem = _ref => {
    ...
    }, getShotName(userInfo.userName))), /*#__PURE__*/React.createElement(View, {
    ...
    }, userInfo.userName, roleDescription(userInfo)))), /*#__PURE__*/React.createElement(View, {
      style: styles.memberItemRight
    }, showOperationButton(userInfo.userID) ? /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(View, {
      style: {
        marginRight: 6
      }
    }, /*#__PURE__*/React.createElement(ZegoDisagreeCoHostButton, {
      onPressed: onCoHostDisagree.bind(this, userInfo.userID),
      inviterID: userInfo.userID
    })), /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(ZegoAgreeCoHostButton, {
      onPressed: onCoHostAgree.bind(this, userInfo.userID),
      inviterID: userInfo.userID
    }))) : null,
    // @ts-ignore
    showOperationIcon(userInfo.userID) ? /*#__PURE__*/React.createElement(TouchableOpacity, {
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    style: styles.title
  }, ZegoTranslationText.memberListTitle, " \xB7 ", memberCount, "\u4EBA")), /*#__PURE__*/React.createElement(View, {
    style: styles.divide
  }), /*#__PURE__*/React.createElement(View, {
