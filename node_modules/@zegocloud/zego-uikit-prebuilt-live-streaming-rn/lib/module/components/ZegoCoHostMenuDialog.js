...
export default function ZegoCoHostMenuDialog(props) {
    ...
    if (invitationType === ZegoInvitationType.inviteToCoHost) {
      ...
      if (countdownTimerMap.current.get(inviteeID)) {
        ...
        setToastExtendedData({
          ...
          text: ZegoTranslationText.repeatInviteCoHostFailedToast
        });
        onCancel();
        result = false;
      } else {
        ...
        if (!ZegoUIKit.getUser(inviteeID)) {
          ...
          setToastExtendedData({
            type: ZegoToastType.error,
            text: ZegoTranslationText.inviteCoHostFailedToast
          });
          onCancel();
        }
      }
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    fontSize: 14,
    color: "#fff",
    text: invitationType === ZegoInvitationType.inviteToCoHost ? ZegoTranslationText.inviteCoHostButton.replace('%0', inviteeID) : ZegoTranslationText.removeCoHostButton,
    invitees: [inviteeID],
    type: invitationType,
  ...
  }, ZegoTranslationText.removeUserMenuDialogButton.replace('%0', inviteeID))), /*#__PURE__*/React.createElement(View, {
    style: styles.divide
  }), /*#__PURE__*/React.createElement(TouchableOpacity, {
  ...
  }, ZegoTranslationText.cancelMenuDialogButton)));
}
