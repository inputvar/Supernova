...
export default function ZegoRequestCoHostButton(props) {
  ...
  const willPressedHandle = () => {
    ...
    if (!hostID) {
      ...
      setToastExtendedData({
        ...
        text: ZegoTranslationText.requestCoHostFailed
      });
      result = false;
  ...
  const pressedHandle = () => {
    ...
    setToastExtendedData({
      ...
      text: ZegoTranslationText.sendRequestCoHostToast
    });
    onRequestSuccessfully();
  };
  return /*#__PURE__*/React.createElement(ZegoSendInvitationButton, {
...
//# sourceMappingURL=ZegoRequestCoHostButton.js.map