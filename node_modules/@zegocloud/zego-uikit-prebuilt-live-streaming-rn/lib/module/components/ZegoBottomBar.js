...
export default function ZegoBottomBar(props) {
  ...
  const getButtonByButtonIndex = (buttonIndex, isFirstLevel) => {
    ...
    switch (buttonIndex) {
      ...
      case ZegoMenuBarButtonName.coHostControlButton:
        return /*#__PURE__*/React.createElement(ZegoCoHostControlButton, {
          key: buttonIndex,
          hostID: hostID,
      ...
      case ZegoMenuBarButtonName.enableChatButton:
        return /*#__PURE__*/React.createElement(ZegoEnableChatButton, {
          width: buttonSize,
          height: buttonSize
        });
    }
  ...
  }, showInRoomMessageButton ? /*#__PURE__*/React.createElement(ZegoMessageButton, {
    userID: userID,
    hostID: hostID,
    onPress: () => {
